...
/*jshint ignore:start*/
(function() {
    function qa(k, p) { k.prototype = eb(p.prototype);
        k.prototype.constructor = k;
        k.base = p.prototype }

    function eb(k) {
        function p() {}
        p.prototype = k; return new p }
    ...
    function $(k, p) { var D = !1;
        0 > k && (D = !0, k *= -1);
        k = "" + k; for (p = p ? p : 1; k.length < p;) k = "0" + k; return D ? "-" + k : k }

    function Ia(k) { if (!k) return k;
        k = k.replace(/^\s\s*/, ""); for (var p = /\s/, D = k.length; p.test(k.charAt(--D));); return k.slice(0, D + 1) }
    ...
    function N(k) { var p = ((k & 16711680) >> 16).toString(16),
            D = ((k & 65280) >> 8).toString(16);
        k = ((k & 255) >> 0).toString(16);
        p = 2 > p.length ? "0" + p : p;
        D = 2 > D.length ? "0" + D : D;
        k = 2 > k.length ? "0" + k : k; return "#" + p + D + k }

    function fb(k, p) { var D = this.length >>> 0,
            r = Number(p) || 0,
            r = 0 > r ? Math.ceil(r) : Math.floor(r); for (0 > r && (r += D); r < D; r++)
    ...
    function Za(k, p, D) {
        ...
        if (isNaN(u)) {
            try {
                ...
                if (!xa) { var H = document.body;
                    xa = document.createElement("span");
                    xa.innerHTML = ""; var F = document.createTextNode("Mpgyi");
                    xa.appendChild(F);
                    H.appendChild(xa) }
                xa.style.display = "";
    ...
    function Ga(k, p, r, u, v) { "undefined" === typeof v && (v = 0);
        this._padding = v;
        this._x1 = k;
        this._y1 = p;
        this._x2 = r;
    ...
    function ka(k, p) { ka.base.constructor.call(this, "TextBlock", null, p, null, null);
        this.ctx = k;
        this._isDirty = !0;
    ...
    (function() {
        ...
        U._fTWm = function(k) { if ("undefined" === typeof U.pro.sCH && !db) try { var p = k[U.fSDec(U.obj.cntx)];
                p[U.fSDec(U.obj.txtBl)] = U.fSDec(U.obj.tp);
                p[U.fSDec(U.obj.fnt)] = 11 + U.fSDec(U.obj.fntStr);
                p[U.fSDec(U.obj.fSy)] = U.fSDec(U.obj.grClr);
                p[U.fSDec(U.obj.fTx)](U.fSDec(U.obj.trVs), 2, k.height - 11 - 2) } catch (r) {} }
    })();
    var $a = {},
        xa = null,
        kb =
        function() { this.ctx.clearRect(0, 0, this.width, this.height);
        ...
        ba = function(k, p, r) {
            ...
            for (var Q = 0; z && Q < z.length; Q++)
                if (p = z[Q], "." === p && 0 > E) E = Q;
                    ...
                    else if ("\u2030" === p) { F *= 1E3; continue } else if ("," === p[0] && "." === p[p.length - 1]) { F /= Math.pow(1E3, p.length - 1);
                        E = Q + p.length - 1; continue } else "E" !== p[0] && "e" !== p[0] || "0" !== p[p.length - 1] || (O = !0);
            ...
            for (O = z = Q = N = E = 0; 0 < L.length;)
                if (p = L.pop(), "#" === p || "0" === p)
                    if (E++, E === I) { var M = F,
                            F = []; if ("0" === p)
                            for (p = I - N - (M ? M.length : 0); 0 < p;) M.unshift("0"), p--; for (; 0 < M.length;) r = M.pop() + r, O++, 0 === O % z && (Q === S && 0 < M.length) && (r = H + r) } else 0 < F.length ? (r = F.pop() + r, N++, O++) : "0" === p && (r = "0" + r, N++, O++), 0 === O %
    ...
    V.prototype.get = function(k) { var p = ra[this._defaultsKey]; if ("options" === k) return this.options && this.options._isPlaceholder ? null : this.options; if (p.hasOwnProperty(k) || p.publicProperties && p.publicProperties.hasOwnProperty(k)) return this[k];
    ...
    V.prototype.trackChanges = function(k) { if (!this.sessionVariables) throw "Session Variable Store not set";
    ...
    ka.prototype.setText = function(k) { this.text = k;
        this._isDirty = !0;
        this._wrappedText = null };
    ...
    ka.prototype._getLineWithWidth = function(k, p, r) {
        ...
        var u = r = 0,
            v = k.length - 1,
            H = Infinity;
        for (this.ctx.font = this._getFontString(); u <= v;) { var H = Math.floor((u + v) / 2),
                F = k.substr(0, H + 1);
            r = this.ctx.measureText(F).width; if (r < p) u = H + 1;
            else if (r > p) v = H - 1;
            else break }
    ...
    ka.prototype._getFontString = function() { var k;
        k = "" + (this.fontStyle ? this.fontStyle + " " : "");
        k += this.fontWeight ? this.fontWeight + " " : "";
        k += this.fontSize ? this.fontSize + "px " : ""; var p = this.fontFamily ? this.fontFamily + "" : "";!r && p && (p = p.split(",")[0], "'" !== p[0] && '"' !== p[0] && (p = "'" + p + "'")); return k += p };
    qa(Va, V);
    qa(Aa, V);
    ...
    Wa.prototype.get = function(k, p) { var r = null;
        0 < this.pool.length ? (r = this.pool.pop(), Oa(r, k, p)) : r = ta(k, p); return r };
    ...
    Na.Chart = function() {
        ...
        function p(a, d) {
            ...
            if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
                ...
                this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ea(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ea(this._preRenderCtx),
                    ...
                    O(this.overlaidCanvas, "mousedown", function(a) { b._mouseEventHandler(a);
                        va(b._dropdownMenu) }, this.allDOMEventHandlers), O(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), O(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart", function(a) { b._touchEventHandler(a) }, this.allDOMEventHandlers), O(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerMove" : "touchmove", function(a) { b._touchEventHandler(a) }, this.allDOMEventHandlers),
        ...
        function I(a, d, b, c, e) { if (null === a || "undefined" === typeof a) return "undefined" === typeof b ? d : b;
            a = parseFloat(a.toString()) * (0 <= a.toString().indexOf("%") ? d / 100 : 1); "undefined" !== typeof c && (a = Math.min(c, a), "undefined" !== typeof e && (a = Math.max(e, a))); return !isNaN(a) && a <= d && 0 <= a ? a : "undefined" === typeof b ? d : b }
        ...
        function fa(a, d, b) { fa.base.constructor.call(this, "Crosshair", "crosshair", d, null, b);
            this.chart = a;
            this.ctx = this.chart.ctx;
            this.axis = b;
        ...
        p.prototype.destroy = function() {
            ...
            for (var d = 0; d < a.length; d++) { var b = a[d][0],
                    c = a[d][1],
                    e = a[d][2],
                    g = a[d][3],
                    g = g || !1;
        ...
        p.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled) {
                if (!this._zoomButton) {
                    ...
                    O(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, ua(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, ua(a, a._zoomButton, "pan"));
            ...
            if (!this._dropdownMenu && this.exportEnabled && r) {
                ...
                O(b, "click", function() { a.print();
                    va(a._dropdownMenu) }, this.allDOMEventHandlers, !0);
                b = document.createElement("div");
                b.style.cssText = "padding: 12px 8px 12px 8px";
                ...
                O(b, "mouseover", function() { d || (this.style.backgroundColor = a.toolbar.backgroundColorOnHover, this.style.color = a.toolbar.fontColorOnHover) }, this.allDOMEventHandlers, !0);
                O(b, "mouseout", function() { d || (this.style.backgroundColor = a.toolbar.backgroundColor, this.style.color = a.toolbar.fontColor) }, this.allDOMEventHandlers, !0);
                O(b, "click", function() { Ta(a.canvas, "jpeg", a.exportFileName);
                    va(a._dropdownMenu) }, this.allDOMEventHandlers, !0);
                b = document.createElement("div");
                b.style.cssText =
                ...
                O(b, "click", function() { Ta(a.canvas, "png", a.exportFileName);
                    va(a._dropdownMenu) }, this.allDOMEventHandlers, !0)
            }
        ...
        p.prototype._updateSize = function() {
            ...
            if (this.canvas.width !== d *
                W || this.canvas.height !== b * W) { for (var c = 0; c < a.length; c++) Oa(a[c], d, b);
                a = !0 } else a = !1;
            return a
        };
        ...
        p.prototype.renderElements = function() {
            ...
            var b = [];
            if (this.animatedRender) { var c = ta(this.width, this.height);
        ...
        p.prototype.render = function(a) { a && (this.options = a);
            this._initialize();
            this.setLayout();
            this.renderElements() };
            ...
            for (var a = "", d = 0; d < this.data.length; d++)
                if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= p._supportedChartTypes.indexOf(a.type)) {
                    for (var b = null, c = !1, e = null, g = !1, m = 0; m < this.plotInfo.plotTypes.length; m++)
                        if (this.plotInfo.plotTypes[m].type === a.type) { c = !0;
                            b = this.plotInfo.plotTypes[m]; break }
                    c || (b = {
                        type: a.type,
                        totalDataSeries: 0,
                        plotUnits: []
                    ...
                    for (m = 0; m < b.plotUnits.length; m++)
                        if (b.plotUnits[m].axisYType === a.axisYType && b.plotUnits[m].axisXType === a.axisXType && b.plotUnits[m].axisYIndex === a.axisYIndex && b.plotUnits[m].axisXIndex === a.axisXIndex) { g = !0;
                            e = b.plotUnits[m]; break }
                    g || (e = {
                        type: a.type,
        ...
        p.prototype.assignIdToDataPoints = function() { for (var a = 0; a < this.data.length; a++) { var d = this.data[a]; if (d.dataPoints)
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    for (w = 0; w < l.dataPoints.length; w++) {
                        ...
                        if (0 < w) { if (a.axisX.logarithmic) { var B = c / l.dataPoints[w - 1].x;
                                1 > B && (B = 1 / B);
                                b.minDiff > B && 1 !== B && (b.minDiff = B) } else B = c - l.dataPoints[w - 1].x, 0 > B && (B *= -1), b.minDiff > B && 0 !== B && (b.minDiff = B);
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d =
                    ...
                    for (n = 0; n < q.dataPoints.length; n++) {
                        ...
                        c < b.min && (b.min = c);
                        c > b.max && (b.max = c);
                        if (0 < n) { if (a.axisX.logarithmic) { var r = c / q.dataPoints[n - 1].x;
                                1 > r && (r = 1 / r);
                                b.minDiff > r && 1 !== r && (b.minDiff = r) } else r = c - q.dataPoints[n - 1].x, 0 > r && (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r);
                        ...
                        else { if (!f && (f = !0, 0 < n)) { n -= 2; continue } if (c > t && !B) B = !0;
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo,
                    ...
                    for (s = 0; s < h.dataPoints.length; s++) {
                        ...
                        if ((e = h.dataPoints[s].y) && e.length) { g = Math.min.apply(null, e);
                            m = Math.max.apply(null, e);
                            B = !0; for (var p = 0; p < e.length; p++) null === e.k && (B = !1);
                            B && (q || (k = f), f = c) }
                        c < b.min && (b.min = c);
                        c > b.max && (b.max = c);
                        g < d.min && (d.min = g);
        ...
        p.prototype.calculateAutoBreaks = function() {
            ...
            function b(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <=
                    ...
                    for (var c = a.axisX.dataInfo, b = c.min, d = c.max, f = c._dataRanges, g, h = 0, l = 0; l < a.dataSeriesIndexes.length; l++) { var m = e.data[a.dataSeriesIndexes[l]]; if (!(4 > m.dataPoints.length))
            ...
            for (var c, e = this, g = !1, m = 0; m <
                this._axes.length; m++)
                if (this._axes[m].scaleBreaks && this._axes[m].scaleBreaks.autoCalculate && 1 <= this._axes[m].scaleBreaks.maxNumberOfAutoBreaks) { g = !0;
                    this._axes[m].dataInfo._dataRanges = []; for (var l = 0; l < 100 / Math.max(parseFloat(this._axes[m].scaleBreaks.collapsibleThreshold) || 10, 10); l++) this._axes[m].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity }) }
            if (g) {
                ...
                for (m = 0; m < this._axes.length; m++)
                    if (this._axes[m].dataInfo._dataRanges) {
                        ...
                        var h = this._axes[m].dataInfo._dataRanges,
                            s, q, g = [];
                        if (this._axes[m].dataInfo.dataPointYPositiveSums) { var n = this._axes[m].dataInfo.dataPointYPositiveSums;
                            s = h; for (l in n)
                                if (n.hasOwnProperty(l) && !isNaN(l) && (q = n[l], !u(q))) { var f = Math.floor((q - w) / c);
                                    q < s[f].min && (s[f].min = q);
                                    q > s[f].max && (s[f].max = q) }
                        ...
                        for (l = 0; l < h.length - 1; l++)
                            if (s = h[l].max, isFinite(s))
                                for (; l < h.length - 1;)
                                    if (w = h[l + 1].min, isFinite(w)) { q = w - s;
                                        q > c && g.push({ diff: q, start: s, end: w }); break } else l++;
        ...
        p.prototype.getDataPointAtXY = function(a, d, b) {
            b = b || !1;
            for (var c = [], e = this._dataInRenderedOrder.length - 1; 0 <= e; e--) { var g = null;
        ...
        p.prototype._plotAreaMouseDown = function(a, d) { this.isDrag = !0;
        ...
        p.prototype._zoomPanToSelectedRegion = function(a, d, b, c,
            ...
            b = a.axesRanges; if (a.isValid)
                for (c = 0; c < d.length; c++) e = b[c], d[c].setViewPortRange(e.val1, e.val2), this.syncCharts && this.syncCharts(e.val1, e.val2); return a.isValid };
        ...
        p.prototype.renderLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = [], m, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var s = h.dataPoints,
                        q = "solid";
                    if (b.setLineDash) { var n = R(h.nullDataLineDashType, h.lineThickness),
                            q = h.lineDashType,
        ...
        p.prototype.renderSpline = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var s = h.dataPoints,
                        q = "solid";
                    if (c.setLineDash) { var n = R(h.nullDataLineDashType, h.lineThickness),
                            q = h.lineDashType,
                            f = R(q, h.lineThickness);
                        c.setLineDash(f) }
                    var B = h.id;
                        ...
                        for (u = !1, p = 0; p < s.length; p++)
                            if (t = s[p].getTime ? s[p].x.getTime() : s[p].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !u)))
                                if ("number" !== typeof s[p].y) 0 < p && !u && (h.connectNullData ? c.setLineDash && (0 < x.length && (h.options.nullDataLineDashType || !s[p - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = n, q = h.nullDataLineDashType) : (d(x), x = [])), u = !0;
                                    ...
                                    if (0 < s[p].markerSize || 0 < h.markerSize) { var y = h.getMarkerProperties(p, t, u, c);
                                        m.push(y);
                                        ma = N(ma);
                                        r && m.push({ x: t, y: u, ctx: e, type: y.type, size: y.size, color: ma, borderColor: ma, borderThickness: y.borderThickness }) }(s[p].indexLabel || h.indexLabel || s[p].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: s[p], dataSeries: h, point: { x: t, y: u }, direction: 0 > s[p].y === a.axisY.reversed ? 1 : -1, color: B });
                                    u = !1
                                }
                    d(x)
                }
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (c = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                else if (q = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) { var A = "undefined" !== typeof g[c] ? g[c] : 0;
                                    q -= A;
                                    y = n - A;
                                    g[c] = A + (y - q) } else A = m[c] ? m[c] : 0, y = q + A, q = n + A, m[c] = A + (y - q);
                    ...
                    if (0 < t.length)
                        for (var u = 5 < f && k.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)
                            if (c = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                else if (q = a.axisY.convertValueToPixel(q), 0 <= t[h].y) { var A = "undefined" !== typeof g[c] ? g[c] : 0;
                                    q -= A;
                                    y = n - A;
                                    a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.y1 - q) && (q = e.y1);
                                    g[c] = A + (y - q) } else A = "undefined" !== typeof m[c] ?
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (c = t[h].x.getTime ? t[h].x.getTime() :
                                ...
                                else if (s = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) { var A = g[c] ? g[c] : 0;
                                    y = n + A;
                                    s += A;
                                    g[c] = A + (s - y) } else A = m[c] ? m[c] : 0, y = s - A, s = n - A, m[c] = A + (s - y);
                                c = t[h].color ? t[h].color : k._colorSet[h % k._colorSet.length];
                        ...
                        for (h = 0; h < t.length; h++)
                            if (c = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                var v = q - a.plotType.plotUnits.length * f / 2 + a.index * f << 0,
                                    y = v + f << 0;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) { l[c] = x + (l[c] ? l[c] : 0); if (0 >= l[c]) continue;
                                    x = g[c] ? g[c] : n;
                                    g[c] = s = a.axisY.convertValueToPixel(l[c]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) w[c] = x + (w[c] ? w[c] : 0), s = m[c] ? m[c] :
                                    n, m[c] = x = a.axisY.convertValueToPixel(w[c]);
                                else if (s = a.axisY.convertValueToPixel(x), 0 <= t[h].y) { var A = g[c] ? g[c] : 0;
                                    x = n + A;
                                    s += A;
                                    a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.x2 - s) && (s = e.x2);
                                    g[c] = A + (s - x) } else A = m[c] ? m[c] : 0, x = s - A, s = n - A, a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.x1 - x) && (x = e.x1), m[c] = A + (s - x);
                                c = t[h].color ? t[h].color : p._colorSet[h % p._colorSet.length];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < p.length) {
                        ...
                        b = "solid";
                        if (g.setLineDash) { var Y = R(B.nullDataLineDashType, B.lineThickness);
                            b = B.lineDashType; var ca = R(b, B.lineThickness);
                            g.setLineDash(ca) }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < n.length) {
                        ...
                        var z = "solid";
                        if (c.setLineDash) { var aa = R(q.nullDataLineDashType, q.lineThickness),
                                z = q.lineDashType,
                        ...
                        for (k = !1; f < n.length; f++)
                            if (B = n[f].x.getTime ? n[f].x.getTime() : n[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax && (!q.connectNullData || !k)))
                                if ("number" !== typeof n[f].y) 0 < f && !k && (q.connectNullData ? c.setLineDash && (0 < x.length && (q.options.nullDataLineDashType ||
                                    ...
                                    if (0 !== n[f].markerSize && (0 < n[f].markerSize || 0 < q.markerSize)) { var ca = q.getMarkerProperties(f, B, k, c);
                                        l.push(ca);
                                        Y = N(Y);
                                        r && l.push({ x: B, y: k, ctx: e, type: ca.type, size: ca.size, color: Y, borderColor: Y, borderThickness: ca.borderThickness }) }(n[f].indexLabel || q.indexLabel || n[f].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
        ...
        p.prototype.renderStackedArea = function(a) {
            function d() {
                if (!(1 > h.length)) {
                    for (0 < A.lineThickness && c.stroke(); 0 < h.length;) { var a = h.pop();
                        c.lineTo(a.x, a.y);
                        r && u.lineTo(a.x, a.y) }
                    c.closePath();
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < s.length) {
                        ...
                        x = "solid";
                        if (c.setLineDash) { var Y = R(A.nullDataLineDashType, A.lineThickness);
                        ...
                        for (var da = !0, n = 0; n < s.length; n++) {
                            ...
                            if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da)))
                                if ("number" !== typeof Z.y) A.connectNullData || (da || C) || d(), da = !0;
                                    ...
                                    var oa =
                                        w[g] ? w[g] : 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { q[g] = Z.y + (q[g] ? q[g] : 0); if (0 >= q[g] && a.axisY.logarithmic) continue;
                                        k = a.axisY.convertValueToPixel(q[g]) } else k = a.axisY.convertValueToPixel(Z.y), k -= oa;
                                    h.push({ x: f, y: p - oa });
                                    w[g] = p - k;
                                    ...
                                    if (0 <= A.dataPointIndexes[g]) { var la = A.dataPointIds[A.dataPointIndexes[g]];
        ...
        p.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) { var y = a.dataSeriesIndexes[v],
                        A = this.data[y],
                        z = A.dataPoints;
                    A.dataPointIndexes = []; for (n = 0; n < z.length; n++) y = z[n].x.getTime ? z[n].x.getTime() : z[n].x, A.dataPointIndexes[y] = n, e[y] || (s.push(y), e[y] = !0);
                    s.sort(Sa) }
                for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                    y = a.dataSeriesIndexes[v];
                    A = this.data[y];
                        ...
                        for (var da = !0, n = 0; n < s.length; n++) {
                            ...
                            if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData ||
                                ...
                                if ("number" !== typeof Z.y) A.connectNullData || (da || u) || d(), da = !0;
                                    ...
                                    f = a.axisX.convertValueToPixel(g);
                                    var la = w[g] ? w[g] : 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { q[g] = oa + (q[g] ? q[g] : 0); if (0 >= q[g] && a.axisY.logarithmic) continue;
                                        k = a.axisY.convertValueToPixel(q[g]) } else k = a.axisY.convertValueToPixel(oa), k -= la;
                                    h.push({ x: f, y: C - la });
                                    w[g] = C - k;
                                    ...
                                    if (0 <= A.dataPointIndexes[g]) { var G = A.dataPointIds[A.dataPointIndexes[g]];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < q.length) {
                        ...
                        var A = "solid";
                        if (c.setLineDash) { var z = R(s.nullDataLineDashType, s.lineThickness),
                                A = s.lineDashType,
                ...
                for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
                    ...
                    if (0 < v.length)
                        for (var x = 5 < n && u.bevelEnabled ? !0 : !1, z = !1, y = null, A = null, m = 0; m < v.length; m++)
                            if (v[m].getTime ? s = v[m].x.getTime() : s = v[m].x, "number" !== typeof v[m].y) { if (0 < m && !z && u.connectNullData) var D = u.options.nullDataLineDashType || !v[m - 1].lineDashType ? u.nullDataLineDashType : v[m - 1].lineDashType;
                                z = !0 } else {
        ...
        var ja = function(a, d, b, c, e, g, m, l, k) {
            if (!(0 > b)) {
                ...
                if (!r) { var h = Number((m % (2 * Math.PI)).toFixed(8));
        ...
        p.prototype.renderPie = function(a) {
                    ...
                    for (var a = 0, b = 0, c = 0, e = 0, d = 0; d < s.length; d++) {
                        ...
                        if (m.midAngle > Math.PI / 2 - t && m.midAngle < Math.PI / 2 + t) {
                            if (0 === a || f[c].midAngle >
                                m.midAngle) c = d;
                            a++
                        } else if (m.midAngle > 3 * Math.PI / 2 - t && m.midAngle < 3 * Math.PI / 2 + t) { if (0 === b || f[e].midAngle > m.midAngle) e = d;
                            b++ }
            ...
            function m() {
                ...
                for (var b = a = 0, d = 0, m = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                    ...
                    var K = function(a,
                        b, c) { for (var e = [], d = 0; e.push(f[b]), b !== c; b = (b + 1 + s.length) % s.length);
            ...
            function l() {
                ...
                if (k.subtitles)
                    for (var a = 0; a < k.subtitles.length; a++) { var b = k.subtitles[a];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 !== z) {
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        l()
                    }, function() { k.disableToolTip = !1;
                        k._animator.animate(0, k.animatedRender ? 500 : 0, function(a) { b(a);
                            l() }) })
                }
            }
        };
        ...
        p.prototype.renderFunnel = function(a) {
            function d() { for (var a = 0, b = [], c = 0; c < C.length; c++) { if ("undefined" === typeof C[c].y) return -1;
                    C[c].y = "number" === typeof C[c].y ? C[c].y : 0;
                    a += Math.abs(C[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < C.length; c++) b.push(Math.abs(C[c].y) * F / a); return b }
            ...
            function b() {
                ...
                f = Math.abs(f);
                f = e + f;
                for (var e = [], g = 0, l = 0; l < C.length; l++) { if ("undefined" === typeof C[l].y) return -1;
            ...
            function e() {
                ...
                d = !1;
                c = 0;
                for (var g, l = L - V - S / 2, l = t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth > l ? l : t.indexLabelMaxWidth : l, h = J.length - 1; 0 <= h; h--) { g = C[J[h].id];
                    c = J[h];
                    e = c.textBlock;
                    b = (a = n(h) < P.length ? J[n(h)] : null) ? a.textBlock : null;
                    c = c.height;
                    a && e.y + c + ga > b.y && (d = !0);
                    c = g.indexLabelMaxWidth || l; if (c > l || 0 > c) c = l;
                    f.push(c) }
                if (d)
            ...
            function m() {
                function a(b, c) { var d; if (0 > b || b >= J.length) return 0; var e, f = J[b].textBlock; if (0 > c) { c *= -1;
                        e = q(b);
                        d = l(e, b); if (d >= c) return f.y -= c, c; if (0 == b) return 0 < d && (f.y -= d), d;
                        d += a(e, -(c - d));
                        0 < d && (f.y -= d); return d }
                    e = n(b);
                    d = l(b, e); if (d >= c) return f.y += c, c; if (b == P.length - 1) return 0 < d && (f.y += d), d;
                    d += a(e, c - d);
                    0 < d && (f.y += d); return d }
                ...
                function c(a, b, d) { var e = [],
                        f = 0,
                        g = 0; for (a = Math.abs(a); d <= b; d++) e.push(P[d]);
                    e.sort(function(a, b) { return a.height - b.height }); for (d = 0; d < e.length; d++)
            ...
            function k(a, b, c) {
                ...
                if (0 === W.length) l =
                    ia;
                else { e = D * (1 != W.length || 0 != W[0] && W[0] != P.length - 1 ? 2 : 1) / h(); for (var q = 0; q < P.length; q++) { if (1 == W.length && 0 == W[0]) { if (0 === q) { l.push(ia[q]);
                                d = m; continue } } else 0 === q && (d = -1 * m);
                        l.push(ia[q] + d); if (0 <= W.indexOf(q) || q < P.length && 0 <= W.indexOf(q + 1)) d += e } }
                    ...
                    if (-1 !== I) {
                        ...
                        this.funnelPyramidClickHandler = function(a) {
                            ...
                            if (!ja && !z.isAnimating && (u(a.dataSeries.explodeOnClick) ||
                                    a.dataSeries.explodeOnClick) && (b = t.reversed ? C.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === t.type || "pyramid" === t.type) t.reversed ? C[C.length - 1 - a].exploded = C[C.length - 1 - a].exploded ? !1 : !0 : C[a].exploded = C[a].exploded ? !1 : !0;
                                k(z, b, 500) }
                        };
                        return { source: Q, dest: this.plotArea.ctx, animationCallback: function(a, b) { M.fadeInAnimation(a, b);
                                1 <= a && (k(z, -1, 500), v(z.plotArea.ctx || z.ctx)) }, easingFunction: M.easing.easeInQuad, animationBase: 0 }
                    }
                }
            }
        };
        ...
        p.prototype.exportChart = function(a) { a = "undefined" === typeof a ? {} : a; var d = a.format ? a.format : "png",
                b = a.fileName ? a.fileName : this.exportFileName; if (a.toDataURL) return this.canvas.toDataURL("image/" + d);
            Ta(this.canvas, d, b) };
        p.prototype.print = function() {
            ...
            setTimeout(function() { c.focus();
                c.print();
                setTimeout(function() { b._canvasJSContainer.removeChild(d) }, 1E3) }, 500)
        };
        p.prototype.getPercentAndTotal = function(a, d) {
            ...
            else if ("pie" === a.type || "doughnut" === a.type || "funnel" === a.type || "pyramid" === a.type) { for (b = c = 0; b < a.dataPoints.length; b++) isNaN(a.dataPoints[b].y) || (c += a.dataPoints[b].y);
        ...
        p.prototype.replaceKeywordsWithValue = function(a, d, b, c, e) {
            ...
            if ((0 <= b.type.indexOf("stacked") ||
                ...
                do {
                    ...
                    if (b.percentFormatString) k = b.percentFormatString;
                            ...
                            h = Math.max(Math.ceil(Math.log(1 / Math.abs(m)) / Math.LN10), 2); if (isNaN(h) || !isFinite(h)) h = 2; for (var s = 0; s < h; s++) k += "#";
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try { var f = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    f && 0 < f.length && (h = Ia(f[2]), a = Ia(f[1])) } catch (l) {}
                f = null;
        ...
        z.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.labels) { a = Math.ceil(c); for (var c = Math.ceil(this.intervalStartPosition), f = !1, b = c; b < this.viewportMaximum; b += a)
            ...
            for (c = 0; c < this._labels.length; c++) { a = this._labels[c].textBlock;
                a.maxWidth = g;
                a.maxHeight = m; var B = a.measureText();
                k = B.height }
            e = [];
            n = q = 0;
                        ...
                        for (b = this.intervalStartPosition <
                            ...
                            if (!this._labels[b].breaksLabelType) {
                                ...
                                for (f = b + 1; f < this._labels.length; f++)
                                    if (!this._labels[f].breaksLabelType) { d = this._labels[f].textBlock;
        ...
        z.prototype.createLabelsAndCalculateWidth = function() {
            ...
            if ("left" === this._position || "right" === this._position) {
                this.createLabels();
                for (d =
                    0; d < this._labels.length; d++) { var c = this._labels[d].textBlock,
                        e = c.measureText(),
                        g = 0,
        ...
        z.prototype.createLabelsAndCalculateHeight = function() {
            ...
            if ("bottom" === this._position || "top" === this._position) {
                for (b = 0; b < this._labels.length; b++) { d = this._labels[b].textBlock; var e = d.measureText(),
                        g = 0,
            ...
            if ("undefined" ===
                ...
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        ...
                        this._labels = b
                    } else { for (h = 0; h < this._labels.length; h++) q = this._labels[h], q.position < this.viewportMinimum || (m = q.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += m);
                        b > this.lineCoordinates.width * e && this.labelAutoFit && (d = !0) }
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic &&
                        !this.equidistantInterval && this.labelAutoFit) { for (var b = [], p, l = this.viewportMaximum, k = this.lineCoordinates.height / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) { q = this._labels[h]; if (q.position < this.viewportMinimum) break;
                ...
                "inside" === this.labelPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                        if (q = a._labels[h], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum || d && 0 !== g++ % 2 && a.labelAutoFit) &&
                            ...
                            a.ctx.strokeStyle = a.tickColor; var b = 1 === this.ctx.lineWidth % 2 ? (n.x << 0) + 0.5 : n.x << 0;
                            a.ctx.save();
                            a.ctx.beginPath();
                            a.ctx.moveTo(b, n.y << 0);
                            a.ctx.lineTo(b, n.y + a.tickLength << 0);
        ...
        z.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                for (var d = this, b, c = 0, e = 0, g = !1, m = !1, l = [], k = [],
                        m = !1, c = 0; c < this.stripLines.length; c++) { var h = this.stripLines[c];
            ...
            if (this.logarithmic) {
                ...
                if (b <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed)
                    for (b = 0; b < e.length; b++) {
                        ...
                        else if (c > e[b].startValue / e[b - 1].endValue) { c /= e[b].startValue / e[b - 1].endValue; if (c < e[b].size) { a *= Math.pow(e[b].endValue / e[b].startValue, 1 === e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) / c; break } else a *= e[b].endValue / e[b].startValue / e[b].size;
                            c /= e[b].size } else break
                    } else
                ...
                else if (c < e[b].endValue / e[b + 1].startValue) { c /= e[b].endValue / e[b + 1].startValue; if (c > 1 / e[b].size) { a *= Math.pow(e[b].endValue / e[b].startValue, 1 >= e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) * c; break } else a /= e[b].endValue / e[b].startValue / e[b].size;
                    c *= e[b].size } else break;
                ...
                if (b <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed)
                    for (b = 0; b < e.length; b++) {
                        ...
                        else if (c > e[b].startValue - e[b - 1].endValue) { c -= e[b].startValue - e[b - 1].endValue; if (c < e[b].size) { a += (e[b].endValue - e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) - c; break } else a += e[b].endValue - e[b].startValue - e[b].size;
                            c -= e[b].size } else break
                    } else
                        for (b = e.length - 1; 0 <= b; b--)
                            if (!(e[b].startValue > this.conversionParameters.minimum))
                ...
                else if (c < e[b].endValue - e[b + 1].startValue) { c -= e[b].endValue - e[b + 1].startValue; if (c > -1 * e[b].size) { a += (e[b].endValue - e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) + c; break } else a -= e[b].endValue - e[b].startValue - e[b].size;
                    c += e[b].size } else break;
        ...
        z.prototype.setViewPortRange = function(a, d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d);
        ...
        z.generateValueFormatString = function(a, d) { var b = "#,##0.",
                c = d;
            1 > a && (c += Math.floor(Math.abs(Math.log(a) / Math.LN10)), isNaN(c) || !isFinite(c)) && (c = d); for (var e = 0; e < c; e++) b += "#"; return b };
        z.getNiceExponent = function(a, d) { var b = Math.floor(Math.log(a) / Math.LN10),
                c = a / Math.pow(10, b),
                c = 0 > b ? 1 >= c ? 1 : 5 >= c ? 5 : 10 : Math.max(Math.floor(c), 1); return -20 > b ? Number(c * Math.pow(10, b)) : Number((c * Math.pow(10, b)).toFixed(20)) };
        z.getNiceNumber =
            function(a, d) { var b = Math.floor(Math.log(a) / Math.LN10),
                    c = a / Math.pow(10, b),
                    c = d ? 1.5 > c ? 1 : 3 > c ? 2 : 7 > c ? 5 : 10 : 1 >= c ? 1 : 2 >= c ? 2 : 5 >= c ? 5 : 10; return -20 > b ? Number(c * Math.pow(10, b)) : Number((c * Math.pow(10, b)).toFixed(20)) };
        ...
        L.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                ...
                } else { if ("zigzag" === this.type) { g = -1;
                        h = e + a;
                        k = c + a;
                        p = (l - h) / a / 2; for (n = 0; n < p; n++) this.ctx.lineTo(k, h), k += 2 * g * a, h += 2 * a, g *= -1;
                        this.ctx.lineTo(k, h);
                        k += m - c; for (n = 0; n < p + 1; n++) this.ctx.lineTo(k, h), k += 2 * g * a, h -= 2 * a, g *= -1;
                        this.ctx.lineTo(k + g * a, h + a) } } else if ("left" === this.scaleBreaks.parent._position || "right" ===
                    ...
                    if (e = 1 === q % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === q % 2 ? (c.y << 0) + 0.5 : c.y << 0, "left" === this.scaleBreaks.parent._position ? (c = this.chart.plotArea.x1, m = this.chart.plotArea.x2 + q / 2 + 0.5 << 0) : (c = this.chart.plotArea.x2, m = this.chart.plotArea.x1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: c, y1: e - q / 2, x2: m, y2: l + q / 2 }, this.ctx.moveTo(c, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(m, e), this.ctx.lineTo(m, l),
                        this.ctx.lineTo(c, l);
                    else if ("wavy" === this.type) { k = c;
                    h = e;
                    g = 0.5;
                    p = (m - k) / a / 3; for (n = 0; n < p; n++) this.ctx.bezierCurveTo(k + a, h + g * a, k + 2 * a, h + g * a, k + 3 * a, h), k += 3 * a, g *= -1;
                    this.ctx.bezierCurveTo(k + a, h + g * a, k + 2 * a, h + g * a, k + 3 * a, h);
                    h = l;
                    g *= -1;
                    this.ctx.lineTo(k, h); for (n = 0; n < p; n++) this.ctx.bezierCurveTo(k - a, h + g * a, k - 2 * a, h + g * a, k - 3 * a, h), k -= 3 * a, g *= -1 } else if ("zigzag" === this.type) {
                    g = 1;
                    h = e - a;
                    k = c + a;
                    p = (m - k) / a / 2;
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" ===
                        ...
                        var l = [];
                        if (this.chart.axisX)
                            for (var p = 0; p < this.chart.axisX.length; p++) { for (var k = this.chart.axisX[p].convertPixelToValue({ y: d }), h = null, c = 0; c < this.chart.axisX[p].dataSeries.length; c++)(h = this.chart.axisX[p].dataSeries[c].getDataPointAtX(k, b)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[p].dataSeries[c], null !== h.dataPoint.y && l.push(h));
                                h = null }
                    ...
                    if (h = this.chart.getDataPointAtXY(a, d, b)) this.currentDataPointIndex = h.dataPointIndex, this.currentSeriesIndex = h.dataSeries.index;
                        ...
                        if (h = ab(a, d, this.chart._eventManager.ghostCtx), 0 < h && "undefined" !== typeof this.chart._eventManager.objectMap[h]) { h = this.chart._eventManager.objectMap[h]; if ("legendItem" === h.objectType) return;
        ...
        $.prototype.enableAnimation = function() { if (!this.container.style.WebkitTransition) { var a = this.getContainerTransition(this.containerTransitionDuration);
        ...
        $.prototype.fixMozTransitionDelay = function(a, d) {
            ...
            else { var b = parseFloat(this.container.style.left),
                    b = isNaN(b) ? 0 : b,
        ...
        ha.prototype.mouseEventHandler = function(a) {
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                e = [];
                for (b = 0; b < this.mouseoveredObjectMaps.length; b++) { g = !0; for (c = 0; c < d.length; c++)
        ...
        var M = {
                yScaleAnimation: function(a, d) { if (0 !== a) { var b = d.dest,
                            c = d.source.canvas,
                            e = d.animationBase;
                        b.drawImage(c, 0, 0, c.width, c.height, 0, e - e * a, b.canvas.width / W, a * b.canvas.height / W) } },
                xScaleAnimation: function(a, d) { if (0 !== a) { var b = d.dest,
                            c = d.source.canvas,
                            e = d.animationBase;
                ...
                fadeInAnimation: function(a, d) { if (0 !== a) { var b = d.dest,
                            c = d.source.canvas;
                        b.save();
                        b.globalAlpha = a;
